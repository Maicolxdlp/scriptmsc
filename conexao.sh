...
if netstat -nltp|grep 'squid' 1>/dev/null 2>/dev/null;then
	echo -e "\E[41;1;37m            ELIMINAR SQUID PROXY              \E[0m"
	echo ""
	echo -ne "\033[1;32mREALMENTE DESEA ELIMINAR EL SQUID \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read resp
	if [[ "$resp" = 's' ]]; then
		echo -e "\n\033[1;32mELIMINANDO EL SQUID PROXY !\033[0m"
		echo ""
		rem_sqd () 
		{
		if [[ -d "/etc/squid/" ]]; then
	    ...
	    fun_bar 'rem_sqd'
		echo -e "\n\033[1;32mSQUID ELIMINADO CON EXITO!\033[0m"
		sleep 3.5s
		clear
		fun_conexao
	else
...
echo -ne "\033[1;32mPARA CONTINUAR CONFIRME SU IP: \033[1;37m"; read -e -i $IP ipdovps
if [[ -z "$ipdovps" ]];then
echo -e "\n\033[1;31mIP invalido\033[1;32m"
echo ""
read -p "Digite seu IP: " IP
fi
echo -e "\n\033[1;33mQUE PUERTOS QUIERES USAR EN SQUID \033[1;31m?"
echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mESTABLECER LOS PUERTOS EN SECUENCIA \033[1;33mEX: \033[1;37m80 8080 8799"
echo ""
echo -ne "\033[1;32mINFORME DE PUERTO\033[1;37m: "; read portass
if [[ -z "$portass" ]]; then
...
addpt_sqd () {
	echo -e "\E[44;1;37m         ADICIONAR PUERTO EN SQUID         \E[0m"
	...
	echo -ne "\033[1;32mQUE PUERTO DESEA ADICIONAR \033[1;33m?\033[1;37m "; read pt
	if [[ -z "$pt" ]]; then
	...
	verif_ptrs $pt
	echo -e "\n\033[1;32mADICIONANDO PUERTO A SQUID!"
	echo ""
	...
	echo -e "\n\033[1;32mPUERTO ADICIONADO CON EXITO!"
	sleep 3
	clear
	fun_squid
}
...
rempt_sqd () {
	echo -e "\E[41;1;37m        RETIRE LA PUERTO DE SQUID        \E[0m"
	...
	if [[ -f "/etc/squid/squid.conf" ]]; then
		...
		echo -e "\n\033[1;31mSQUID NO ESTÁ INSTALADO!\033[0m"
		echo -e "\n\033[1;31mVolviendo...\033[0m"
		sleep 2
		clear
		fun_squid
	fi
	echo -ne "\033[1;32mQUE PUERTO DEA ELIMINAR \033[1;33m?\033[1;37m "; read pt
	if [[ -z "$pt" ]]; then
		echo -e "\n\033[1;31mPuerto invalido!"
		sleep 2
		clear
	...
	if grep -E "$pt" $var_sqd > /dev/null 2>&1; then
		echo -e "\n\033[1;32mELIMINANDO PUERTO SQUID!"
		echo ""
		...
		echo ""
		fun_bar 'service squid restart' 'service squid3 restart'
		echo -e "\n\033[1;32mPUERTO ELIMINADO CON EXITO!"
		sleep 3.5s
		clear
		fun_squid
	else
		echo -e "\n\033[1;31mPORTA \033[1;32m$pt \033[1;31mNO ENCONTRADO!"
		sleep 3.5s
		clear
		fun_squid
	fi
...
case $x in
	...
	;;
	*)
	echo -e "\033[1;31mOpcion Invalido...\033[0m"
	sleep 2
	fun_conexao
	;;
	esac
...
fun_drop () {
	if netstat -nltp|grep 'dropbear' 1>/dev/null 2>/dev/null;then
		clear
		[[ $(netstat -nltp|grep -c 'dropbear') != '0' ]] && dpbr=$(netstat -nplt |grep 'dropbear' | awk -F ":" {'print $4'} | xargs) || sqdp="\033[1;31mNO DISPONIBLE"
		...
		echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mCAMBIAR PUERTO DROPBEAR\033[0m"
		echo -e "\033[1;31m[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mELIMINAR DROPBEAR\033[0m"
		...
		if [[ "$resposta" = '1' ]]; then
			...
			echo ""
			echo -ne "\033[1;32mQUE PUERTO DESEA ULTILIZAR \033[1;33m?\033[1;37m "; read pt
			echo ""
			verif_ptrs $pt
			var1=$(sed -n '6 p' /etc/default/dropbear)
			echo -e "\033[1;32mCAMBIAR PUERTO DROPBEAR!"
			...
			echo -e "\n\033[1;32mRETIRAR DROPBEAR !\033[0m"
			echo ""
			fun_dropunistall () {
			...
			echo -e "\n\033[1;32mDROPBEAR RETIRADO CON EXITO !\033[0m"
			sleep 3
			clear
			fun_conexao
		...
		echo -e "\n\033[1;33mEsta a punto de instalar DROPBEAR !\033[0m\n"
		echo -ne "\033[1;32mDESEA CONTINUAR \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read resposta
		if [[ "$resposta" = 's' ]]; then
			echo -e "\n\033[1;33mDEFINE UN PUERTO PARA EL DROPBEAR !\033[0m\n"
			echo -ne "\033[1;32mQUE PUERTO \033[1;33m:\033[1;37m "; read porta
			if [[ -z "$porta" ]]; then
				echo -e "\n\033[1;31mPuerto invalido!"
				sleep 3
				clear
			...
			echo -e "\n\033[1;32mINSTALACION CONCLUIDA \033[1;33mPUERTO: \033[1;37m$porta\033[0m"
...
if netstat -nltp|grep 'stunnel4' 1>/dev/null 2>/dev/null;then
    ...
    echo ""
    echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mCAMBIAR PUERTO SSL TUNNEL\033[0m"
    echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mELIMINAR SSL TUNNEL\033[0m"
    echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mVOLVER\033[0m"
    echo ""
    echo -ne "\033[1;32mQUE DESEA HACER \033[1;33m:\033[1;37m "; read resposta
    echo ""
    if [[ "$resposta" = '1' ]]; then
    echo -ne "\033[1;32mQUE PUERTI DESEA UTILIZAR \033[1;33m:\033[1;37m "; read porta
    echo ""
	if [[ -z "$porta" ]]; then
		echo ""
	...
	echo ""
	netstat -nltp|grep 'stunnel4' > /dev/null && echo -e "\033[1;32mPUERTI CAMBIADO CON EXITO !" || echo -e "\033[1;31mERROR INESPERADO!"
	sleep 3.5s
	clear
	fun_conexao
	fi
	if [[ "$resposta" = '2' ]]; then
		echo -e "\033[1;32mELIMINANDO  SSL TUNNEL !\033[0m"
		del_ssl () {
		...
		fun_bar 'del_ssl'
		echo ""
		echo -e "\033[1;32mSSL TUNNEL ELIMINANDO CON EXITO!\033[0m"
		sleep 3
		fun_conexao
	else
		echo -e "\033[1;31mVolviendo...\033[0m"
	...
	echo -e "\n\033[1;33mUSTED ESTA A PUNTO DE INSTALAR EL TÚNEL SSL !\033[0m"
	echo ""
	echo -ne "\033[1;32mDESEA CONTINUAR \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read resposta
	if [[ "$resposta" = 's' ]]; then
	echo -e "\n\033[1;33mDEFINE UN PUERTO PARA TUNEL SSL !\033[0m"
	echo ""
	read -p "$(echo -e "\033[1;32mQUE PUERTO DEASEA UTILIZAR? \033[1;37m")" -e -i 3128 porta
	if [[ -z "$porta" ]]; then
		echo ""
		echo -e "\033[1;31mPuerto invalido!"
		sleep 3
	...
	verif_ptrs $porta
	echo -e "\n\033[1;32mINSTALANDO SSL TUNNEL !\033[1;33m"
	echo ""
    ...
    echo -e "\n\033[1;32mSSL TUNNEL INSTALADO CON EXITO !\033[1;31m PUERTO: \033[1;33m$porta\033[0m"
    sleep 3
    clear
    fun_conexao
    else
...
if grep -qs "CentOS release 5" "/etc/redhat-release"; then
	echo "CentOS 5 es demasiado viejo y no es compatible"
	exit 4
fi
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
		...
		echo ""
		echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mCAMBIAR PUERTO"
		echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mELIMINAR OPENVPN"
		...
		echo -e "\033[1;31m[\033[1;36m5\033[1;31m] \033[1;37m• \033[1;33mCAMBIAR HOST DNS"
		echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mVOLVER"
		echo ""
		echo -ne "\033[1;32mQUE DESEA HACER \033[1;33m:\033[1;37m "; read option
		case $option in
			1) 
			clear
			...
			verif_ptrs
			echo ""
			echo -e "\033[1;32mCAMBIAR PUERTO OPENVPN!\033[1;33m"
			echo ""
			fun_opn () {
		    ...
		    fun_bar 'fun_opn'
		    echo ""
		    echo -e "\033[1;32mPUERTO ALTERADO CON EXITO!\033[1;33m"
		    sleep 3
		    fun_conexao
			;;
			2) 
			echo ""
			echo -ne "\033[1;32mDESEA ELIMINAR OPENVPN \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read REMOVE
			if [[ "$REMOVE" = 's' ]]; then
				rmv_open () {
			    ...
			    echo ""
			    echo -e "\033[1;32mELIMINANDO OPENVPN!\033[0m"
			    echo ""
			    fun_bar 'rmv_open'
				echo ""
				echo -e "\033[1;32mOPENVPN ELIMINADO CON EXITO!\033[0m"
				sleep 3
				fun_conexao
			else
				echo ""
			...
			echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mELIMINAR HOST DNS"
			...
			if [[ -z "$resp" ]]; then
				echo ""
				echo -e "\033[1;31mOpcion invalido!"
				sleep 3
				fun_openvpn
			fi
			if [[ "$resp" = '1' ]]; then
				...
				echo ""
				echo -e "\033[1;33mLista de hosts actuales:\033[0m "
				echo ""
				i=0
				...
				echo ""
				echo -ne "\033[1;33mDigite el host para ser adicionado\033[1;37m : " ; read host
				if [[ -z $host ]]; then
					echo ""
					echo -e "\E[41;1;37m        Campo vacío o inválido !       \E[0m"
					sleep 2
					fun_openvpn
				fi
				if [[ "$(grep -w "$host" /etc/hosts | wc -l)" -gt "0" ]] ; then
					echo -e "\E[41;1;37m    Este host ya está agregado !    \E[0m"
					sleep 2
					fun_openvpn
				fi
				sed -i "3i\127.0.0.1 $host" /etc/hosts
				echo ""
				echo -e "\E[44;1;37m      Host adicionado con éxito!      \E[0m"
			    sleep 2
			    fun_openvpn
			elif [[ "$resp" = '2' ]]; then
				clear
				...
				echo ""
				echo -e "\033[1;33mLista de host actuales:\033[0m "
				echo ""
				i=0
				for _host in `grep -w "127.0.0.1" /etc/hosts | grep -v "localhost" | cut -d' ' -f2`; do
					i=$(expr $i + 1)
				...
				echo ""
				echo -ne "\033[1;32mSeleccione el host para ser removido \033[1;33m[\033[1;37m1\033[1;31m-\033[1;37m$i\033[1;33m]\033[1;37m: " ; read option
				if [[ -z $option ]]; then
					echo ""
					echo -e "\E[41;1;37m          Opcion invalido  !        \E[0m"
					sleep 2
					fun_openvpn
				fi
				...
				echo "$hst" > /etc/hosts
				echo ""
				echo -e "\E[41;1;37m      Host removido con exito !      \E[0m"
			    sleep 2
			    fun_openvpn
			elif [[ "$resp" = '3' ]]; then
			    echo -e "\n\033[1;32mCAMBIO DE ARCHIVO \033[1;37m/etc/hosts\033[0m"
			    echo -e "\n\033[1;31mATENCION!\033[0m"
			    echo -e "\n\033[1;33mPARA AHORRAR UTILICE LAS TECLAS \033[1;32mctrl x y\033[0m"
			    sleep 4
			    clear
			    nano /etc/hosts
	...
	echo ""
	# OpenVPN instalador e criaado do primeiro usuario
	echo -e "\033[1;33mRESPONDA LAS PREGUNTAS PARA COMENZAR LA INSTALACIÓN"
	echo ""
	echo -ne "\033[1;32mPARA CONTINUAR CONFIRME SU IP: \033[1;37m"; read -e -i $IP IP
	if [[ -z "$IP" ]]; then
				echo ""
	...
	echo ""
	read -p "$(echo -e "\033[1;32mCUAL DNS DESEA UTILIZAR:\033[1;37m")" -e -i 2 DNS
	echo ""
	...
	echo ""
	read -p "$(echo -e "\033[1;32mPROTOCOLO PARA UTILIZAR : \033[1;37m")" -e -i 2 resp
	if [[ "$resp" = '1' ]]; then
		PROTOCOL=udp
	elif [[ "$resp" = '2' ]]; then
		PROTOCOL=tcp
	...
	echo ""
	if [[ "$OS" = 'debian' ]]; then
		echo -e "\033[1;32mATUALIZANDO SISTEMA"
		echo ""
		fun_attos () {
		apt-get update-y
		apt-get upgrade -y
...
float" > /etc/openvpn/client-common.txt
	...
	newclient "SSHPLUS"
	echo ""
	echo -e "\033[1;32mOPENVPN INSTALADO CON EXITO\033[0m"
fi
...
fun_socks () {
	...
	echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mABRIR PUERTO\033[0m"
	echo -e "\033[1;31m[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mCAMBIAR STATUS\033[0m"
	echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;37m• \033[1;33mVOLVER\033[0m"
	echo ""
	echo -ne "\033[1;32mQUE DESEA HACER \033[1;33m:\033[1;37m "; read resposta
	if [[ "$resposta" = '1' ]]; then
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			echo -e "\033[1;32mDESATIVANDO PROXY SOCKS\033[1;33m"
			echo ""
			fun_bar 'fun_socksoff'
			echo ""
			echo -e "\033[1;32mPROXY SOCKS DESATIVADO CON ÉXITO!\033[1;33m"
			sleep 3
			fun_socks
		else
			clear
		    ...
		    echo ""
		    echo -e "\033[1;32mPROXY SOCKS ATIVADO CON EXITO\033[1;33m"
		    sleep 3
		    fun_socks
		fi
	elif [[ "$resposta" = '2' ]]; then
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			verif_ptrs $porta
			echo ""
			echo -e "\033[1;32mINICIANDO PROXY SOCKS CON PUERTO \033[1;31m$porta\033[1;33m"
			echo ""
			abrirptsks () {
				sleep 1
				screen -dmS proxy python /etc/SSHPlus/proxy.py $porta
			...
			clear
			echo -e "\033[1;31mFUNCION NO DISPONIBLE\n\n\033[1;33mATIVE SOCKS PRIMERO !\033[1;33m"
			sleep 2
			fun_socks
		fi
	elif [[ "$resposta" = '3' ]]; then
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			echo ""
			echo -ne "\033[1;32mQUE COLOR\033[1;31m ?\033[1;37m : "; read sts_cor
...
fun_openssh () {
	...
	echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mADICIONAR PUERTO\033[1;31m
[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mREMOVER PUERTO\033[1;31m
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mVOLVER\033[0m"
	echo ""
	echo -ne "\033[1;32mQUE DESEA HACER \033[1;33m:\033[1;37m "; read resp
	if [[ "$resp" = '1' ]]; then
		clear
		echo -e "\E[44;1;37m         ADICIONAR PUERTO SSH         \E[0m\n"
		echo -ne "\033[1;32mQUE PUERT9 DESEA ADICIONAR \033[1;33m?\033[1;37m "; read pt
		if [[ -z "$pt" ]]; then
			echo -e "\n\033[1;31mPuerto invalido!"
			sleep 3
			fun_conexao
		...
		verif_ptrs $pt
		echo -e "\n\033[1;32mADICIONANDO PUERTO SSH\033[0m"
		echo ""
		fun_addpssh () {
		...
		clear
		echo -e "\E[41;1;37m         REMOVER PUERTO SSH         \E[0m"
		echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mPUERTO ESTANDAR \033[1;37m22 \033[1;33mCUIDADO !\033[0m"
		echo -e "\n\033[1;33mPUERTO EN USO: \033[1;37m$(grep 'Port' /etc/ssh/sshd_config|cut -d' ' -f2 |grep -v 'no' |xargs)\n"
		echo -ne "\033[1;32mQUE PUERTO DESEA REMOVER \033[1;33m?\033[1;37m "; read pt
		if [[ -z "$pt" ]]; then
			echo -e "\n\033[1;31mPuerto invalido!"
			sleep 3
			fun_conexao
		...
		[[ $(grep -wc "$pt" '/etc/ssh/sshd_config') != '0' ]] && {
			echo -e "\n\033[1;32mREMOVIENDO PUERTO SSH\033[0m"
			echo ""
			fun_delpssh () {
...
fun_sslh () {
 [[ "$(netstat -nltp|grep 'sslh' |wc -l)" = '0' ]] && {
    ...
    echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mA PUERTO \033[1;37m443 \033[1;32mSERA USADA POR ESTÁNDAR\033[0m\n"
	echo -ne "\033[1;32mREALMENTE DESEA INSTALAR SSLH \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read resp
	if [[ "$resp" = 's' ]]; then
        verif_ptrs 443
        fun_instsslh () {
	...
	echo -ne "\033[1;32mREALMENTE DESEA REMOVER SSLH \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read respo
    if [[ "$respo" = "s" ]]; then
	    fun_delsslh () {
...
clear
echo -e "\E[44;1;37m                MODO DE CONEXIÓN                 \E[0m\n"
...
[[ "$(netstat -nltp|grep 'sslh' |wc -l)" != '0' ]] && {
	echo -e "\033[1;32mSERVICIO: \033[1;33mSSLH: \033[1;32mPUERTO: \033[1;37m$(netstat -nplt |grep 'sslh' |awk {'print $4'} |cut -d: -f2 |xargs)"
	sts7="\033[1;32m◉ "
} || {
	sts7="\033[1;31m○ "
}
...
[[ -e "/etc/stunnel/stunnel.conf" ]] && {
	echo -e "\033[1;32mSERVICIO: \033[1;33mSSL TUNNEL \033[1;32mPUERTO: \033[1;37m$(netstat -nplt |grep 'stunnel' | awk {'print $4'} |cut -d: -f2 |xargs)"
	sts3="\033[1;32m◉ "
} || {
	sts3="\033[1;31m○ "
}
...
[\033[1;36m08\033[1;31m] \033[1;37m• \033[1;33mACTIVAR-PORT JUEGOS\033[1;32m◉\033[1;31m
[\033[1;36m09\033[1;31m] \033[1;37m• \033[1;33mAUMENTAR VELOCIDAD TCP\033[1;32m◉\033[1;31m
[\033[1;36m00\033[1;31m] \033[1;37m• \033[1;33mVOVER \033[1;32m< \033[0m"
echo ""
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo ""
tput civis
echo -ne "\033[1;32mQUE DESEA HACER\033[1;33m:\033[1;37m "; read x
tput cnorm
clear
case $x in
	1|01)
