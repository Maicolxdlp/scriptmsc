#!/bin/bash
clear
echo -e "\033[1;32mDESEA DESISTALAR MSC SCRIPT\033[1;33m"
...
if [[ "$resp" = s || "$resp" = S ]];then
    ...
    clear
    echo -e "\033[1;36mObligado por utilizar MSC PERU\033[1;33m"
    sleep 2
    cat /dev/null > ~/.bash_history && history -c && exit 0
else
    echo -e "\033[1;32mOk retornando al menu\033[1;33m"
    sleep 3
    menu
fi