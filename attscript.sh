...
echo -e "   \033[1;32mVERIFICANDO ACTUALIZACIONES DISPONIBLES\033[0m\n"

fun_bar 'fun_atts'

[[ ! -f "/tmp/att" ]] && {

	echo -e "\n\033[1;31m ERROR AL CONECTAR EL SERVIDOR\n"

	echo -ne "\033[1;31m ENTER \033[1;33mpara retornar al \033[1;32mMENU!\033[0m"; read
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;36m     EL SCRIPT SE ESTA ACTUALIZADO!\033[1;32m\n"

  rm /tmp/att > /dev/null 2>&1

  echo -e " \033[1;33m MAS INFORMACIONES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@mscvip\n"
  ...
  echo -e "  \033[1;33mMAS INFORMACIONES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@MSCVIP\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    echo -ne "\033[1;31mENTER \033[1;33mpara retornar al \033[1;32mMENU!\033[0m"; read
