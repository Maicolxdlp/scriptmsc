...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-15s\n' "Crear usuario teste" ; tput sgr0
echo ""
[ "$(ls -A /etc/SSHPlus/userteste)" ] && echo -e "\033[1;32mTeste Ativo!\033[1;37m" || echo -e "\033[1;31mNingun test ativo!\033[0m"
echo ""
...
then
echo ""
tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "contraseña vació o invalida." ; echo "" ; tput sgr0
	exit 1
fi
...
clear
echo -e "\E[44;1;37m     Usuario Teste Creado     \E[0m"
echo ""
