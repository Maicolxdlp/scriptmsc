...
if [[ -z $option ]]; then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "  Usuario vacio y inválido!   " ; echo "" ; tput sgr0
	exit 1
elif [[ -z $user ]]; then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo " Usuário vacío y inválido! " ; echo "" ; tput sgr0
	exit 1
else
	...
	tput setaf 7 ; tput setab 4 ; tput bold ; printf '%32s%s%-13s\n' "Remover Usuário SSH" ; tput sgr0
	echo ""
	echo -ne "\033[1;33mREALMENTE DESEA REMOVER TODOS USUARIOS \033[1;37m[s/n]: "; read opc	
	if [[ "$opc" = "s" ]]; then
	echo -e "\n\033[1;33mAguarde\033[1;32m.\033[1;31m.\033[1;33m.\033[0m"
        ...
        rm *.zip > /dev/null 2>&1
		echo -e "\n\033[1;32mUSUARIOS REMOVIDOS CON EXITO!\033[0m"
		sleep 2
		menu
	else
		echo -e "\n\033[1;31mRetornando al menu...\033[0m"
		sleep 2
		menu
	fi
elif [[ "$resp" = "3" ]]; then
