...
if [ ! -f "$database" ]; then
    ...
    if [[ -z $option ]]; then
        tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Usuario vacío o inexistente" ; echo "" ; tput sgr0
		exit
	elif [[ -z $usuario ]]; then
		tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Usuario vacío o inexistente" ; echo "" ; tput sgr0
		exit 1
		...
		if cat /etc/passwd |grep -w $usuario > /dev/null; then
			echo -ne "\n\033[1;32mNuevo límite para el usuario. \033[1;33m$usuario\033[1;37m: "; read sshnum
			if [[ -z $sshnum ]]
			then
				tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Ingresaste un número no válido!" ; echo "" ; tput sgr0
				exit 1
			else
				...
				then
					...
					if [[ $sshnum -lt 1 ]]
					then
						tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Debe ingresar un número mayor que cero!" ; echo "" ; tput sgr0
						exit 1
					else
						...
						tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Limite aplicado para el usuário $usuario foi $sshnum " ; tput sgr0
						sleep 2
						exit
					fi
				fi
			...
			tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "el usuário $usuario no fue encontrado" ; echo "" ; tput sgr0
			exit 1
		fi
	fi
fi