...
if [[ -e /etc/openvpn/server.conf ]]; then
  ...
  rmt3=$(cat /etc/IP)
  prx='200.142.130.104'
  vivo1="portalrecarga.vivo.com.pe/recarga"
  vivo2="portalrecarga.vivo.com.pe/controle/"
  vivo3="navegue.claro.com.pe/pre/"
  vivo4="navegue.claro.com.pe/controle/"
  vivo5="www.vivo.com.pe"
...
fun_edithost () {
  ...
  echo ""
  echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;33mCLARO RECARGA"
  echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;33mCLARO NAVEGUE 3G"
  echo -e "\033[1;31m[\033[1;36m3\033[1;31m] \033[1;33mCLARO MMS \033[1;31m[\033[1;37mAPN: \033[1;32mmms.claro.com.pe\033[1;31m]"
  echo -e "\033[1;31m[\033[1;36m4\033[1;31m] \033[1;33mHOST 4G \033[1;31m[\033[1;32mAlgunas Regiones\033[1;31m]"
  echo -e "\033[1;31m[\033[1;36m5\033[1;31m] \033[1;33mMODO BYPASS \033[1;31m[\033[1;32mopen + http injector\033[1;31m]"
  echo -e "\033[1;31m[\033[1;36m6\033[1;31m] \033[1;33mTODOS HOST \033[1;31m[\033[1;32m1 Ovpn de cada\033[1;31m]" 
  echo -e "\033[1;31m[\033[1;36m7\033[1;31m] \033[1;33mEDITAR MANUALMENTE"
  echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;33mVOLVER"
  echo ""
  echo -ne "\033[1;32mQUE HOST QUIERE USAR \033[1;33m?\033[1;37m "; read respo
  if [[ -z "$respo" ]]; then
    echo ""
  ...
  if [[ "$respo" = '1' ]]; then
    echo ""
    echo -e "\033[1;32mCAMBIO DE HOST!\033[0m"
    echo ""
    fun_althost () {
    ...
    fun_bar 'fun_althost'
    echo ""
    echo -e "\033[1;32mHOST CAMBIÓ CON ÉXITO!\033[0m"
    fun_geraovpn
    sleep 1.5
  elif [[ "$respo" = '2' ]]; then
    echo ""
    ...
    sleep 1.5
      ...
      echo ""
      echo -e "\033[1;32mCAMBIADO CON ÉXITO!\033[0m"
      sleep 1.5
  elif [[ "$respo" = '7' ]]; then
    echo ""
    echo -e "\033[1;32mCAMBIO DE ARCHIVO OVPN!\033[0m"
    echo ""
    echo -e "\033[1;31mATENCION!\033[0m"
    echo ""
    echo -e "\033[1;33mPARA AHORRAR UTILICE LAS TECLAS \033[1;32mctrl x y\033[0m"
    sleep 4
    clear
...
then
  tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Este usuario ya existe. prueba con otro nombre." ; echo "" ; tput sgr0
  exit 1  
else
  if (echo $username | egrep [^a-zA-Z0-9.-_] &> /dev/null)
  then
    tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Ingresaste un nombre de usuario no válido!" ; tput setab 1 ; echo "Use solo letras, números, puntos y guiones." ; tput setab 4 ; echo "No use espacios, acentos o caracteres especiales.!" ; echo "" ; tput sgr0
    exit 1
  else
    sizemin=$(echo ${#username})
    if [[ $sizemin -lt 2 ]]
    then
      tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Ingresaste un nombre de usuario muy corto," ; echo "usar al menos dos caracteres!" ; echo "" ; tput sgr0
      exit 1
    else
      sizemax=$(echo ${#username})
      if [[ $sizemax -gt 10 ]]
      then
        tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Ingresaste un nombre de usuario muy largo," ; echo "usa un máximo de 10 caracteres!" ; echo "" ; tput sgr0
        exit 1
      else
        if [[ -z $username ]]
        then
          tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Ingresaste un nombre de usuario vacío!" ; echo "" ; tput sgr0
          exit 1
        else  
           echo -ne "\033[1;32mContraseña:\033[1;37m "; read password
          if [[ -z $password ]]
          then
            tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Has ingresado una contraseña vacía!" ; echo "" ; tput sgr0
            exit 1
          else
            sizepass=$(echo ${#password})
            if [[ $sizepass -lt 4 ]]
            then
              tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "¡Contraseña corta!, Use al menos 4 caracteres" ; echo "" ; tput sgr0
              exit 1
            else  
                echo -ne "\033[1;32mDias Para Expirar:\033[1;37m "; read dias
              if (echo $dias | egrep '[^0-9]' &> /dev/null)
              then
                tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Ingresaste un número inválido de días!" ; echo "" ; tput sgr0
                exit 1
              else
                if [[ -z $dias ]]
                then
                  tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Ha dejado el número de días para que la cuenta caduque vacía!" ; echo "" ; tput sgr0
                  exit 1
                else  
                  if [[ $dias -lt 1 ]]
                  then
                    tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Debe ingresar un número de días mayor que cero!" ; echo "" ; tput sgr0
                    exit 1
                  else
                      echo -ne "\033[1;32mLímite de conexión:\033[1;37m "; read sshlimiter
                    if (echo $sshlimiter | egrep '[^0-9]' &> /dev/null)
                    then
                      tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Ingresaste un número de conexión no válido!" ; echo "" ; tput sgr0
                      exit 1
                    else
                      if [[ -z $sshlimiter ]]
                      then
                        tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Dejaste el límite de conexión vacío!" ; echo "" ; tput sgr0
                        exit 1
                      else
                        if [[ $sshlimiter -lt 1 ]]
                        then
                          ...
                          if [[ -e /etc/openvpn/server.conf ]]; then
                              ...
                              if [[ "$resp" = @(s|S) ]]; then
                                ...
                                echo -ne "\033[1;32mCon usuario y contraseña \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read respost
                                echo -ne "\033[1;32mHost Actual\033[1;37m: \033[1;31m(\033[1;37m$Host\033[1;31m) \033[1;37m- \033[1;32mCambio \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read oprc
                                if [[ "$oprc" = @(s|S) ]]; then
                                  fun_edithost
                                else
                                   fun_geraovpn
                                ...
                                [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32mIP: \033[1;37m$IP" ; echo -e "\033[1;32mUsuário: \033[1;37m$username" ; echo -e "\033[1;32mContraseña: \033[1;37m$password" ; echo -e "\033[1;32mExpira en: \033[1;37m$gui" ; echo -e "\033[1;32mLimite de conexiónes: \033[1;37m$sshlimiter" ; echo "" || echo "No se pudo crear un usuario!" ; tput sgr0
                                sleep 1
                                function aguarde {
                                  helice () {
