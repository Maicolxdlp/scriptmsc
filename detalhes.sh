#!/bin/bash
clear
echo -e "\E[44;1;37m               INFORMACIONES DE VPS                 \E[0m"
echo ""
...
echo -e "\033[1;33mCodeNombre: \033[1;37m$codename"
...
echo -e "\033[1;33multilizacion: \033[37m$uso"
echo ""
else
echo -e "\033[1;32mPROCESSADOR\033[0m"
echo ""
echo "No fue posible obtener información"
fi
...
echo -e "\033[1;33multiliza: \033[37m$usoram"
echo ""
else
...
echo -e "\033[1;31m• \033[1;32mSERVICOS EN EJECUCIÓN\033[1;31m •\033[0m"
echo ""
PT=$(lsof -V -i tcp -P -n | grep -v "ESTABLISHED" |grep -v "COMMAND" | grep "LISTEN")
for porta in `echo -e "$PT" | cut -d: -f2 | cut -d' ' -f1 | uniq`; do
    svcs=$(echo -e "$PT" | grep -w "$porta" | awk '{print $1}' | uniq)
    echo -e "\033[1;33mServico \033[1;37m$svcs \033[1;33mPuerto \033[1;37m$porta"
done