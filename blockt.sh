...
fun_spn1 () {
	...
	echo -ne "\033[1;31mDESMONTAJE FIREWALL\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DOk"
}
read -p "$(echo -e "\033[1;32mDESEO QUITAR LAS REGLAS DE FIREWALL? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
	echo ""	
	fun_spn1
	echo ""
	...
	if [[ -e /etc/openvpn/openvpn-status.log ]]; then
		echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m REINICIE EL SISTEMA PARA CONCLUIR"
		echo ""
...
echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m FUNCION BETA ULTILIZE POR SU CUENTA EN RIESGO"
echo ""
